...
{products.map((product,idx)=>(
  <SwiperSlide key={product._id}>
    ...
    <div className="max-w-sm max-w-lg w-full mt-5 rounded-xl overflow-hidden shadow-lg bg-white border border-gray-200  flex flex-col h-[400px]">
    <img
...
/>
      ...
      <div className='p-5 flex-1 flex flex-col'>
        ...
        <p className='text-gray-700 mb-4 text-sm h-[48px]'>{product.description.length>50 ? product.description.slice(0,50)+'...':product.description}</p>
