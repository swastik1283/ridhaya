...
const Women = () => {
    ...
    useEffect(()=>{
        ...
        if(res.data.success){
            const womensproduct=res.data.productRidaya.filter(
                (product)=>product.category === "Women"
            );
            setwomen(womensproduct);
  console.log(setwomen)
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <h2 className="text-3xl font-semibold mb-4 text-center">WOMEN'S COLLECTION</h2>
